...
public class WalkZone1 extends JFrame implements ActionListener {
    ...
    private ZoneClicked one, two, three, four, five, six, seven, eight, nine, ten, eleven, twelve;
    ...
    public void actionPerformed(ActionEvent e) {
        if(e.getSource() == footer) {
            ...
            if (eleven.isClicked()) clickedPanels.add(eleven);
            if (twelve.isClicked()) clickedPanels.add(twelve);
